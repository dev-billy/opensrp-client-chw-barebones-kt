package org.smartregister.chw.barebone.provider
...
open class BaseTestRegisterProvider(
...
) : RecyclerViewProvider<BaseTestRegisterProvider.RegisterViewHolder> {
    ...
    override fun createViewHolder(parent: ViewGroup) = RegisterViewHolder(
        inflater.inflate(R.layout.test_register_list_row_item, parent, false)
    )
        ...
        try {
            ...
            with(viewHolder) {
                ...
                patientColumn.apply {
                    ...
                    tag = pc
                    setTag(R.id.VIEW_ID, BaseTestRegisterFragment.CLICK_VIEW_NORMAL)
                }
                dueButton.apply {
                    setOnClickListener(onClickListener)
                    tag = pc
                    setTag(R.id.VIEW_ID, BaseTestRegisterFragment.FOLLOW_UP_VISIT)
                }
